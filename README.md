...
```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/aws-codedeploy-sample
```

Ensure the `.env.test.local` file has required environment variables:

```
DATABASE_URL=postgresql://<YOUR_DB_USERNAME>@localhost:5432/aws-codedeploy-sample_test
```
